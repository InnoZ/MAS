...
public class PersonRegionTypeHandler implements DefaultHandler {
	...
	public void handle(SurveyObject obj, Map<String, String> attributes, String surveyType) {
		...
		String regionType = attributes.get(SurveyConstants.regionType(surveyType));
		
		if(regionType != null){
			
			person.setRegionType(Integer.parseInt(regionType));
