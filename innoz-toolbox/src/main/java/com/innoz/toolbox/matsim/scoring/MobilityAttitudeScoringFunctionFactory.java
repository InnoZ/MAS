...
public class MobilityAttitudeScoringFunctionFactory implements ScoringFunctionFactory {
	...
	@Inject
	public MobilityAttitudeScoringFunctionFactory(final CharyparNagelScoringParametersForPerson params, final MobilityAttitudeConfigGroup ma,
	...
	public ScoringFunction createNewScoringFunction(Person person) {
		...
		sumScoringFunction.addScoringFunction(new MobilityAttitudeLegScoring( parameters ,
				...
				this.network, this.config.getScaleFactor()));
