...
public class SharingSubTourPermissableModesCalculator implements PermissibleModesCalculator{
	...
	public SharingSubTourPermissableModesCalculator(final Scenario scenario, final String[] availableModes, 
	...
	public Collection<String> getPermissibleModes(Plan plan) {
		...
		try {
		 ...
		 if(this.memberships.getPerPersonMemberships().get(personId).getMembershipsPerCSType().containsKey("bikesharing")) {
			 l.add("pedelec");
		 }
