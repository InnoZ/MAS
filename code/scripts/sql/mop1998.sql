create table mop1998.households(
...
copy mop1998.households from '/home/dhosse/mop/1998/Haushalte.csv' delimiter ';'

create view view_mop1998_households as select
id as "Haushalts-ID",
...
from mop1998.households;

create table mop1998.persons(
id character varying,
...
copy mop1998.persons from '/home/dhosse/mop/1998/Personen.csv' delimiter ';';

create view view_mop1998_persons as select
id as "Haushalts-ID",
...
from mop1998.persons;

create table mop1998.children(
id character varying,
persnr character varying,
jahr numeric,
ausfueller numeric,
...
copy mop1998.children from '/home/dhosse/mop/1998/Kinder.csv' delimiter ';';

create view view_mop1998_children as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
ausfueller as "Ausfüllender",
...
bahncard as "Bahncard vorhanden",
fahrrad as "Fahrrad vorhanden"
from mop1998.children;

create table mop1998.personsWithoutJournal(
id character varying,
persnr character varying,
jahr numeric,
ausfueller numeric,
...
copy mop1998.personswithoutjournal from '/home/dhosse/mop/1998/PoT.csv' delimiter ';';

create view view_mop1998_pot as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
ausfueller as "Ausfüllender",
...
moped as "Mofa / Moped / Motorrad vorhanden",
fahrrad as "Fahrrad vorhanden"
from mop1998.personswithoutjournal;

create table mop1998.ways(
id character varying,
persnr character varying,
jahr numeric,
wotag numeric,
...
copy mop1998.ways from '/home/dhosse/mop/1998/Wege.csv' delimiter ';';

create view view_mop1998_ways as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
wotag as "Wochentag",
...
create table mop1998.personDays(
id character varying,
persnr character varying,
jahr numeric,
gewhhpwo numeric,
...
copy mop1998.personDays from '/home/dhosse/mop/1998/Personentage.csv' delimiter ';';

create view view_mop1998_personDays as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
