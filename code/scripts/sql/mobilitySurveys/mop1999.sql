create table mop1999.households(
...
copy mop1999.households from '/home/dhosse/mop/1999/Haushalte.csv' delimiter ';'

create view view_mop1999_households as select
id as "Haushalts-ID",
...
from mop1999.households;

create table mop1999.persons(
id character varying,
...
copy mop1999.persons from '/home/dhosse/mop/1999/Personen.csv' delimiter ';';

create view view_mop1999_persons as select
id as "Haushalts-ID",
...
from mop1999.persons;

create table mop1999.children(
id character varying,
persnr character varying,
jahr numeric,
ausfueller numeric,
...
copy mop1999.children from '/home/dhosse/mop/1999/Kinder.csv' delimiter ';';

create view view_mop1999_children as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
ausfueller as "Ausfüllender",
...
bahncard as "Bahncard vorhanden",
fahrrad as "Fahrrad vorhanden"
from mop1999.children;

create table mop1999.personsWithoutJournal(
id character varying,
persnr character varying,
jahr numeric,
ausfueller numeric,
...
copy mop1999.personswithoutjournal from '/home/dhosse/mop/1999/PoT.csv' delimiter ';';

create view view_mop1999_pot as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
ausfueller as "Ausfüllender",
...
moped as "Mofa / Moped / Motorrad vorhanden",
fahrrad as "Fahrrad vorhanden"
from mop1999.personswithoutjournal;

create table mop1999.ways(
id character varying,
persnr character varying,
jahr numeric,
wotag numeric,
...
copy mop1999.ways from '/home/dhosse/mop/1999/Wege.csv' delimiter ';';

create view view_mop1999_ways as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
wotag as "Wochentag",
...
create table mop1999.personDays(
id character varying,
persnr character varying,
jahr numeric,
gewhhpwo numeric,
...
copy mop1999.personDays from '/home/dhosse/mop/1999/Personentage.csv' delimiter ';';

create view view_mop1999_personDays as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
