create table mop2006.households(
...
copy mop2006.households from '/home/dhosse/mop/2006/Haushalte.csv' delimiter ';'

create view view_mop2006_households as select
id as "Haushalts-ID",
...
from mop2006.households;

create table mop2006.persons(
id character varying,
...
copy mop2006.persons from '/home/dhosse/mop/2006/Personen.csv' delimiter ';';

create view view_mop2006_persons as select
id as "Haushalts-ID",
...
from mop2006.persons;

create table mop2006.children(
id character varying,
persnr character varying,
jahr numeric,
ausfueller numeric,
...
copy mop2006.children from '/home/dhosse/mop/2006/Kinder.csv' delimiter ';';

create view view_mop2006_children as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
ausfueller as "Ausfüllender",
...
bahncard as "Bahncard vorhanden",
fahrrad as "Fahrrad vorhanden"
from mop2006.children;

create table mop2006.personsWithoutJournal(
id character varying,
persnr character varying,
jahr numeric,
ausfueller numeric,
...
copy mop2006.personswithoutjournal from '/home/dhosse/mop/2006/PoT.csv' delimiter ';';

create view view_mop2006_pot as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
ausfueller as "Ausfüllender",
...
moped as "Mofa / Moped / Motorrad vorhanden",
fahrrad as "Fahrrad vorhanden"
from mop2006.personswithoutjournal;

create table mop2006.ways(
id character varying,
persnr character varying,
jahr numeric,
wotag numeric,
...
copy mop2006.ways from '/home/dhosse/mop/2006/Wege.csv' delimiter ';';

create view view_mop2006_ways as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
wotag as "Wochentag",
...
create table mop2006.personDays(
id character varying,
persnr character varying,
jahr numeric,
gewhhpwo numeric,
...
copy mop2006.personDays from '/home/dhosse/mop/2006/Personentage.csv' delimiter ';';

create view view_mop2006_personDays as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
