create table mop1997.households(
...
copy mop1997.households from '/home/dhosse/mop/1997/Haushalte.csv' delimiter ';'

create view view_mop1997_households as select
id as "Haushalts-ID",
...
from mop1997.households;

create table mop1997.persons(
id character varying,
...
copy mop1997.persons from '/home/dhosse/mop/1997/Personen.csv' delimiter ';';

create view view_mop1997_persons as select
id as "Haushalts-ID",
...
from mop1997.persons;

create table mop1997.children(
id character varying,
persnr character varying,
jahr numeric,
ausfueller numeric,
...
copy mop1997.children from '/home/dhosse/mop/1997/Kinder.csv' delimiter ';';

create view view_mop1997_children as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
ausfueller as "Ausfüllender",
...
bahncard as "Bahncard vorhanden",
fahrrad as "Fahrrad vorhanden"
from mop1997.children;

create table mop1997.personsWithoutJournal(
id character varying,
persnr character varying,
jahr numeric,
ausfueller numeric,
...
copy mop1997.personswithoutjournal from '/home/dhosse/mop/1997/PoT.csv' delimiter ';';

create view view_mop1997_pot as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
ausfueller as "Ausfüllender",
...
moped as "Mofa / Moped / Motorrad vorhanden",
fahrrad as "Fahrrad vorhanden"
from mop1997.personswithoutjournal;

create table mop1997.ways(
id character varying,
persnr character varying,
jahr numeric,
wotag numeric,
...
copy mop1997.ways from '/home/dhosse/mop/1997/Wege.csv' delimiter ';';

create view view_mop1997_ways as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
wotag as "Wochentag",
...
create table mop1997.personDays(
id character varying,
persnr character varying,
jahr numeric,
gewhhpwo numeric,
...
copy mop1997.personDays from '/home/dhosse/mop/1997/Personentage.csv' delimiter ';';

create view view_mop1997_personDays as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
