create table mop2000.households(
...
copy mop2000.households from '/home/dhosse/mop/2000/Haushalte.csv' delimiter ';'

create view view_mop2000_households as select
id as "Haushalts-ID",
...
from mop2000.households;

create table mop2000.persons(
id character varying,
...
copy mop2000.persons from '/home/dhosse/mop/2000/Personen.csv' delimiter ';';

create view view_mop2000_persons as select
id as "Haushalts-ID",
...
from mop2000.persons;

create table mop2000.children(
id character varying,
persnr character varying,
jahr numeric,
ausfueller numeric,
...
copy mop2000.children from '/home/dhosse/mop/2000/Kinder.csv' delimiter ';';

create view view_mop2000_children as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
ausfueller as "Ausfüllender",
...
bahncard as "Bahncard vorhanden",
fahrrad as "Fahrrad vorhanden"
from mop2000.children;

create table mop2000.personsWithoutJournal(
id character varying,
persnr character varying,
jahr numeric,
ausfueller numeric,
...
copy mop2000.personswithoutjournal from '/home/dhosse/mop/2000/PoT.csv' delimiter ';';

create view view_mop2000_pot as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
ausfueller as "Ausfüllender",
...
moped as "Mofa / Moped / Motorrad vorhanden",
fahrrad as "Fahrrad vorhanden"
from mop2000.personswithoutjournal;

create table mop2000.ways(
id character varying,
persnr character varying,
jahr numeric,
wotag numeric,
...
copy mop2000.ways from '/home/dhosse/mop/2000/Wege.csv' delimiter ';';

create view view_mop2000_ways as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
wotag as "Wochentag",
...
kmgew as "KM-Gewicht",
datgew as "Sondergewicht zum Ausgleich des späten Erhebungszeitraums"
from mop2000.ways;

create table mop2000.personDays(
id character varying,
persnr character varying,
jahr numeric,
gewhhpwo numeric,
...
copy mop2000.personDays from '/home/dhosse/mop/2000/Personentage.csv' delimiter ';';

create view view_mop2000_personDays as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
