create table mop2001.households(
...
copy mop2001.households from '/home/dhosse/mop/2001/Haushalte.csv' delimiter ';'

create view view_mop2001_households as select
id as "Haushalts-ID",
...
from mop2001.households;

create table mop2001.persons(
id character varying,
...
copy mop2001.persons from '/home/dhosse/mop/2001/Personen.csv' delimiter ';';

create view view_mop2001_persons as select
id as "Haushalts-ID",
...
from mop2001.persons;

create table mop2001.children(
id character varying,
persnr character varying,
jahr numeric,
ausfueller numeric,
...
copy mop2001.children from '/home/dhosse/mop/2001/Kinder.csv' delimiter ';';

create view view_mop2001_children as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
ausfueller as "Ausfüllender",
...
bahncard as "Bahncard vorhanden",
fahrrad as "Fahrrad vorhanden"
from mop2001.children;

create table mop2001.personsWithoutJournal(
id character varying,
persnr character varying,
jahr numeric,
ausfueller numeric,
...
copy mop2001.personswithoutjournal from '/home/dhosse/mop/2001/PoT.csv' delimiter ';';

create view view_mop2001_pot as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
ausfueller as "Ausfüllender",
...
moped as "Mofa / Moped / Motorrad vorhanden",
fahrrad as "Fahrrad vorhanden"
from mop2001.personswithoutjournal;

create table mop2001.ways(
id character varying,
persnr character varying,
jahr numeric,
wotag numeric,
...
copy mop2001.ways from '/home/dhosse/mop/2001/Wege.csv' delimiter ';';

create view view_mop2001_ways as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
wotag as "Wochentag",
...
create table mop2001.personDays(
id character varying,
persnr character varying,
jahr numeric,
gewhhpwo numeric,
...
copy mop2001.personDays from '/home/dhosse/mop/2001/Personentage.csv' delimiter ';';

create view view_mop2001_personDays as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
