create table mop2002.households(
...
copy mop2002.households from '/home/dhosse/mop/2002/Haushalte.csv' delimiter ';'

create view view_mop2002_households as select
id as "Haushalts-ID",
...
from mop2002.households;

create table mop2002.persons(
id character varying,
...
copy mop2002.persons from '/home/dhosse/mop/2002/Personen.csv' delimiter ';';

create view view_mop2002_persons as select
id as "Haushalts-ID",
...
from mop2002.persons;

create table mop2002.children(
id character varying,
persnr character varying,
jahr numeric,
ausfueller numeric,
...
copy mop2002.children from '/home/dhosse/mop/2002/Kinder.csv' delimiter ';';

create view view_mop2002_children as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
ausfueller as "Ausfüllender",
...
bahncard as "Bahncard vorhanden",
fahrrad as "Fahrrad vorhanden"
from mop2002.children;

create table mop2002.personsWithoutJournal(
id character varying,
persnr character varying,
jahr numeric,
ausfueller numeric,
...
copy mop2002.personswithoutjournal from '/home/dhosse/mop/2002/PoT.csv' delimiter ';';

create view view_mop2002_pot as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
ausfueller as "Ausfüllender",
...
moped as "Mofa / Moped / Motorrad vorhanden",
fahrrad as "Fahrrad vorhanden"
from mop2002.personswithoutjournal;

create table mop2002.ways(
id character varying,
persnr character varying,
jahr numeric,
wotag numeric,
...
copy mop2002.ways from '/home/dhosse/mop/2002/Wege.csv' delimiter ';';

create view view_mop2002_ways as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
wotag as "Wochentag",
...
create table mop2002.personDays(
id character varying,
persnr character varying,
jahr numeric,
gewhhpwo numeric,
...
copy mop2002.personDays from '/home/dhosse/mop/2002/Personentage.csv' delimiter ';';

create view view_mop2002_personDays as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
