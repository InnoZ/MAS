create table mop2003.households(
...
copy mop2003.households from '/home/dhosse/mop/2003/Haushalte.csv' delimiter ';'

create view view_mop2003_households as select
id as "Haushalts-ID",
...
from mop2003.households;

create table mop2003.persons(
id character varying,
...
copy mop2003.persons from '/home/dhosse/mop/2003/Personen.csv' delimiter ';';

create view view_mop2003_persons as select
id as "Haushalts-ID",
...
from mop2003.persons;

create table mop2003.children(
id character varying,
persnr character varying,
jahr numeric,
ausfueller numeric,
...
copy mop2003.children from '/home/dhosse/mop/2003/Kinder.csv' delimiter ';';

create view view_mop2003_children as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
ausfueller as "Ausfüllender",
...
bahncard as "Bahncard vorhanden",
fahrrad as "Fahrrad vorhanden"
from mop2003.children;

create table mop2003.personsWithoutJournal(
id character varying,
persnr character varying,
jahr numeric,
ausfueller numeric,
...
copy mop2003.personswithoutjournal from '/home/dhosse/mop/2003/PoT.csv' delimiter ';';

create view view_mop2003_pot as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
ausfueller as "Ausfüllender",
...
moped as "Mofa / Moped / Motorrad vorhanden",
fahrrad as "Fahrrad vorhanden"
from mop2003.personswithoutjournal;

create table mop2003.ways(
id character varying,
persnr character varying,
jahr numeric,
wotag numeric,
...
copy mop2003.ways from '/home/dhosse/mop/2003/Wege.csv' delimiter ';';

create view view_mop2003_ways as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
wotag as "Wochentag",
...
create table mop2003.personDays(
id character varying,
persnr character varying,
jahr numeric,
gewhhpwo numeric,
...
copy mop2003.personDays from '/home/dhosse/mop/2003/Personentage.csv' delimiter ';';

create view view_mop2003_personDays as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
