create table mop2007.households(
...
copy mop2007.households from '/home/dhosse/mop/2007/Haushalte.csv' delimiter ';'

create view view_mop2007_households as select
id as "Haushalts-ID",
...
from mop2007.households;

create table mop2007.persons(
id character varying,
...
copy mop2007.persons from '/home/dhosse/mop/2007/Personen.csv' delimiter ';';

create view view_mop2007_persons as select
id as "Haushalts-ID",
...
mobeinschr as "Gesundheitliche Einschränkungen der Mobilität",
...
from mop2007.persons;

create table mop2007.children(
id character varying,
persnr character varying,
jahr numeric,
ausfueller numeric,
...
copy mop2007.children from '/home/dhosse/mop/2007/Kinder.csv' delimiter ';';

create view view_mop2007_children as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
ausfueller as "Ausfüllender",
...
bahncard as "Bahncard vorhanden",
fahrrad as "Fahrrad vorhanden"
from mop2007.children;

create table mop2007.personsWithoutJournal(
id character varying,
persnr character varying,
jahr numeric,
ausfueller numeric,
...
copy mop2007.personswithoutjournal from '/home/dhosse/mop/2007/PoT.csv' delimiter ';';

create view view_mop2007_pot as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
ausfueller as "Ausfüllender",
...
moped as "Mofa / Moped / Motorrad vorhanden",
fahrrad as "Fahrrad vorhanden"
from mop2007.personswithoutjournal;

create table mop2007.ways(
id character varying,
persnr character varying,
jahr numeric,
wotag numeric,
...
copy mop2007.ways from '/home/dhosse/mop/2007/Wege.csv' delimiter ';';

create view view_mop2007_ways as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
wotag as "Wochentag",
...
create table mop2007.personDays(
id character varying,
persnr character varying,
jahr numeric,
gewhhpwo numeric,
...
copy mop2007.personDays from '/home/dhosse/mop/2007/Personentage.csv' delimiter ';';

create view view_mop2007_personDays as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
