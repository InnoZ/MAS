create table mop2005.households(
...
copy mop2005.households from '/home/dhosse/mop/2005/Haushalte.csv' delimiter ';'

create view view_mop2005_households as select
id as "Haushalts-ID",
...
from mop2005.households;

create table mop2005.persons(
id character varying,
...
copy mop2005.persons from '/home/dhosse/mop/2005/Personen.csv' delimiter ';';

create view view_mop2005_persons as select
id as "Haushalts-ID",
...
from mop2005.persons;

create table mop2005.children(
id character varying,
persnr character varying,
jahr numeric,
ausfueller numeric,
...
copy mop2005.children from '/home/dhosse/mop/2005/Kinder.csv' delimiter ';';

create view view_mop2005_children as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
ausfueller as "Ausfüllender",
...
bahncard as "Bahncard vorhanden",
fahrrad as "Fahrrad vorhanden"
from mop2005.children;

create table mop2005.personsWithoutJournal(
id character varying,
persnr character varying,
jahr numeric,
ausfueller numeric,
...
copy mop2005.personswithoutjournal from '/home/dhosse/mop/2005/PoT.csv' delimiter ';';

create view view_mop2005_pot as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
ausfueller as "Ausfüllender",
...
moped as "Mofa / Moped / Motorrad vorhanden",
fahrrad as "Fahrrad vorhanden"
from mop2005.personswithoutjournal;

create table mop2005.ways(
id character varying,
persnr character varying,
jahr numeric,
wotag numeric,
...
copy mop2005.ways from '/home/dhosse/mop/2005/Wege.csv' delimiter ';';

create view view_mop2005_ways as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
wotag as "Wochentag",
...
create table mop2005.personDays(
id character varying,
persnr character varying,
jahr numeric,
gewhhpwo numeric,
...
copy mop2005.personDays from '/home/dhosse/mop/2005/Personentage.csv' delimiter ';';

create view view_mop2005_personDays as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
