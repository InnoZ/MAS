create table mop2004.households(
...
copy mop2004.households from '/home/dhosse/mop/2004/Haushalte.csv' delimiter ';'

create view view_mop2004_households as select
id as "Haushalts-ID",
...
from mop2004.households;

create table mop2004.persons(
id character varying,
...
copy mop2004.persons from '/home/dhosse/mop/2004/Personen.csv' delimiter ';';

create view view_mop2004_persons as select
id as "Haushalts-ID",
...
from mop2004.persons;

create table mop2004.children(
id character varying,
persnr character varying,
jahr numeric,
ausfueller numeric,
...
copy mop2004.children from '/home/dhosse/mop/2004/Kinder.csv' delimiter ';';

create view view_mop2004_children as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
ausfueller as "Ausfüllender",
...
bahncard as "Bahncard vorhanden",
fahrrad as "Fahrrad vorhanden"
from mop2004.children;

create table mop2004.personsWithoutJournal(
id character varying,
persnr character varying,
jahr numeric,
ausfueller numeric,
...
copy mop2004.personswithoutjournal from '/home/dhosse/mop/2004/PoT.csv' delimiter ';';

create view view_mop2004_pot as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
ausfueller as "Ausfüllender",
...
moped as "Mofa / Moped / Motorrad vorhanden",
fahrrad as "Fahrrad vorhanden"
from mop2004.personswithoutjournal;

create table mop2004.ways(
id character varying,
persnr character varying,
jahr numeric,
wotag numeric,
...
copy mop2004.ways from '/home/dhosse/mop/2004/Wege.csv' delimiter ';';

create view view_mop2004_ways as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
wotag as "Wochentag",
...
create table mop2004.personDays(
id character varying,
persnr character varying,
jahr numeric,
gewhhpwo numeric,
...
copy mop2004.personDays from '/home/dhosse/mop/2004/Personentage.csv' delimiter ';';

create view view_mop2004_personDays as select
id as "Haushalts-ID",
persnr as "Personen-ID",
jahr as "Erhebungsjahr",
